...
var api = {
  ...
  clientId: utils.envOverride(
    "OLYMPUS_CLIENT_ID",
    "925248826443-qdkug0b2s0tl2csq7hjdcdhk4rbvos7k.apps.googleusercontent.com"
  ),
  clientSecret: utils.envOverride("OLYMPUS_CLIENT_SECRET", "Qx008qmy_hkRf99swzuw_0w5"),
  cloudloggingOrigin: utils.envOverride(
    "OLYMPUS_CLOUDLOGGING_URL",
    "https://logging.googleapis.com"
  ),
  adminOrigin: utils.envOverride("OLYMPUS_ADMIN_URL", "https://admin.firebase.com"),
  appengineOrigin: utils.envOverride("OLYMPUS_APPENGINE_URL", "https://appengine.googleapis.com"),
  authOrigin: utils.envOverride("OLYMPUS_AUTH_URL", "https://accounts.google.com"),
  consoleOrigin: utils.envOverride("OLYMPUS_CONSOLE_URL", "https://console.firebase.google.com"),
  deployOrigin: utils.envOverride(
    "OLYMPUS_DEPLOY_URL",
    utils.envOverride("OLYMPUS_UPLOAD_URL", "https://deploy.firebase.com")
  ),
  firebaseApiOrigin: utils.envOverride("OLYMPUS_API_URL", "https://firebase.googleapis.com"),
  firedataOrigin: utils.envOverride("OLYMPUS_FIREDATA_URL", "https://mobilesdk-pa.googleapis.com"),
  firestoreOrigin: utils.envOverride("FIRESTORE_URL", "https://firestore.googleapis.com"),
  functionsOrigin: utils.envOverride(
    "OLYMPUS_FUNCTIONS_URL",
    "https://cloudfunctions.googleapis.com"
  ),
  googleOrigin: utils.envOverride(
    "OLYMPUS_TOKEN_URL",
    utils.envOverride("OLYMPUS_GOOGLE_URL", "https://www.googleapis.com")
  ),
  hostingOrigin: utils.envOverride("OLYMPUS_HOSTING_URL", "https://firebaseapp.com"),
  realtimeOrigin: utils.envOverride("OLYMPUS_REALTIME_URL", "https://firebaseio.com"),
  resourceManagerOrigin: utils.envOverride(
    "OLYMPUS_RESOURCEMANAGER_URL",
    "https://cloudresourcemanager.googleapis.com"
  ),
  rulesOrigin: utils.envOverride("OLYMPUS_RULES_URL", "https://firebaserules.googleapis.com"),
  runtimeconfigOrigin: utils.envOverride(
    "OLYMPUS_RUNTIMECONFIG_URL",
    "https://runtimeconfig.googleapis.com"
  ),
  storageOrigin: utils.envOverride("OLYMPUS_STORAGE_URL", "https://storage.googleapis.com"),
  hostingApiOrigin: utils.envOverride(
    "OLYMPUS_HOSTING_API_URL",
